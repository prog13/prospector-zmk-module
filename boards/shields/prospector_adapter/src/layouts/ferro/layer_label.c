...
int zmk_widget_layer_label_init(struct zmk_widget_layer_label *widget, lv_obj_t *parent) {
    ...
    lv_obj_set_style_text_color(widget->obj, lv_color_hex(ferro_palette_active()->bright), 0);
...
void zmk_widget_layer_label_reskin(struct zmk_widget_layer_label *widget) {
    lv_obj_set_style_text_color(widget->obj, lv_color_hex(ferro_palette_active()->bright), 0);
}
